...
//     {"enable", &runMyRecordCfg.enable, SDK_CFG_DATA_TYPE_S32, "1", "rw", 0, 1, NULL},
//     {"stream_no", &runMyRecordCfg.stream_no, SDK_CFG_DATA_TYPE_S32, "0", "rw", 0, 3, "0-3"},
//     {"recordMode", &runMyRecordCfg.recordMode, SDK_CFG_DATA_TYPE_S32, "3", "rw", 0, 3, NULL},
//     {"preRecordTime", &runMyRecordCfg.preRecordTime, SDK_CFG_DATA_TYPE_S32, "0", "rw", 0, 10, NULL},
//     {"audioRecEnable", &runMyRecordCfg.audioRecEnable, SDK_CFG_DATA_TYPE_S32, "1", "rw", 0, 1, NULL},
//     {"recAudioType", &runMyRecordCfg.recAudioType, SDK_CFG_DATA_TYPE_S32, "2", "rw", 0, 3, NULL},
//     {"recordLen", &runMyRecordCfg.recordLen, SDK_CFG_DATA_TYPE_S32, "5", "rw", 1, 1440, NULL},
