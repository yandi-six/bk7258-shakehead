...
#ifndef _SDK_CFG_EVENT_PUSH_H__
#define _SDK_CFG_EVENT_PUSH_H__
...
} SDK_NET_EVENT_PUSH_CFG, *LPSDK_NET_EVENT_PUSH_CFG;


extern int EventPushCfgSave();
extern int EventPushCfgLoad();
extern void EventPushCfgPrint();
extern int EventPushCfgLoadDefValue();
extern cJSON* EventPushCfgLoadJson();
extern int EventPushJsonSaveCfg(cJSON *json);
#define EVENT_PUSH_CFG_FILE "eventpush_cfg.cjson"

extern SDK_NET_EVENT_PUSH_CFG runEventPushCfg;
extern SDK_CFG_MAP eventPushMap[];
