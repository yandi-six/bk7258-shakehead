...
typedef struct
{
	int (*mailbox_send_media_req_msg) (u32 param1,u32 param2,u32 param3); //在init_sockets时注册
...
//加的+++++
#define  APP_COM_REBOOT             			APP_COM_BASE+18
#define  APP_COM_CHANGE_SEM             		APP_COM_BASE+19 //告诉CPU0释放信号量
#define  APP_COM_NETFAIL             			APP_COM_BASE+20 //告诉CPU1  netfail 播放netfail音频
#define  APP_COM_LED_ON				APP_COM_BASE+21
#define  APP_COM_LED_OFF				APP_COM_BASE+22
#define  APP_COM_LED_STATE				APP_COM_BASE+23
#define  APP_COM_MEDIA_STOP				APP_COM_BASE+24
#define  APP_COM_IRLED_ON				APP_COM_BASE+25
#define  APP_COM_IRLED_OFF				APP_COM_BASE+26
#define  APP_COM_OTA_START				APP_COM_BASE+27
#define  APP_SEND_OTA_PROCESS				APP_COM_BASE+28
#define  APP_COM_OTA_CONTINUTE          		APP_COM_BASE+29 //告诉cpu0 jixu ota下载
#define  APP_COM_OTA_REBOOT         			APP_COM_BASE+30 //告诉cpu0 reboot
#define  APP_COM_WRITE_CFG         			APP_COM_BASE+31
#define  APP_COM_RTC_UPDATE         			APP_COM_BASE+32//CPU1请求rtc时间
#define  CPU0_SEND_RTC_UPDATE        			APP_COM_BASE+33//cpu0发送rtc时间
//#define  CPU1_ASK_IFRAME_CALLBACK       			APP_COM_BASE+34//
...
#define  CPU12_COM_ROI_SET    	CPU12_COM_BASE+5
#define  CPU12_COM_ROICFG_LOAD    	CPU12_COM_BASE+6
#define CPU12_COM_MOTION_TEST		CPU12_COM_BASE+7
