...
const uint8_t sensor_gc2145_640_368_table[][2] = //+++
{
	{0xfe, 0x00},
	{0xfe, 0x00},
	{0xf8, 0x85},
...
const uint8_t sensor_gc2145_640_368_25fps_table[][2] =
{
	//////////////frame rate 50Hz/////////
	{0xfe, 0x00},
	{0x05, 0x01},
...
int gc2145_set_ppi(media_ppi_t ppi)
{
	...
	switch (ppi)
	{
		...
		case PPI_640X368:
		{
			size = sizeof(sensor_gc2145_640_368_table) / 2;

			for (i = 0; i < size; i++)
			{
				SENSOR_I2C_WRITE(sensor_gc2145_640_368_table[i][0],
				                 sensor_gc2145_640_368_table[i][1]);

				gc2145_read_register(sensor_gc2145_640_368_table[i][0],
				                     sensor_gc2145_640_368_table[i][1]);
			}
			ret = 0;
		}
...
int gc2145_set_fps(frame_fps_t fps)
{
	...
	os_printf("gc2145_set_fps: width: %d ,fps:%d\n", width , fps);
	...
	if (width == 0x0170)
	{
		size = sizeof(sensor_gc2145_640_368_25fps_table) / 2;

		for (i = 0; i < size; i++)
		{
			SENSOR_I2C_WRITE(sensor_gc2145_640_368_25fps_table[i][0],
								sensor_gc2145_640_368_25fps_table[i][1]);

			gc2145_read_register(sensor_gc2145_640_368_25fps_table[i][0],
									sensor_gc2145_640_368_25fps_table[i][1]);
		}
...
const dvp_sensor_config_t dvp_sensor_gc2145 =
{
	...
	.ppi_cap = PPI_CAP_480X480 | PPI_CAP_640X368 | PPI_CAP_640X480 | PPI_CAP_800X480 | PPI_CAP_1280X720 | PPI_CAP_1600X1200,
	.id = ID_GC2145,
