...
const uint8_t sensor_gc0308_init_talbe[][2] =
{
		...
		#if 1
		{0x03, 0x01},//unit exposure
		{0x04, 0x90},
		

		
		{0xe2, 0x00},//anti_fliker_step
		{0xe3, 0x64},
		
		{0xe4, 0x02}, // exp level  16.67fps
		{0xe5, 0x58},
		{0xe6, 0x03}, // 12.5fps
		{0xe7, 0x20},
		{0xe8, 0x04}, //8.33fps
		...
		{0x8f, 0x00},
		{0x90, 0x00},
		{0x91, 0x3c},//Signed b4 LSC row center
		{0x92, 0x50},//LSC column center
		{0x5d, 0x12},
		{0x5e, 0x1a},
		{0x5f, 0x24},
		{0x60, 0x07}, // DNDD 去噪
		...
		{0x53, 0x80},
		{0x56, 0x80},
		{0x8b, 0x40},//lsc read b2
		{0x8c, 0x26},//lsc green b2
		{0x8d, 0x30},//lsc blue b2
		{0x8e, 0x08},//lsc read b4
		{0x8f, 0x00},//lsc greem b4
		{0x90, 0x00},//lsc blue b4
		{0x94, 0x02},
		{0x95, 0x07},
		{0x96, 0xe0},
		{0xb1, 0x38}, //saturation_Cb
		{0xb2, 0x38}, //saturation_Cr
		{0xb3, 0x38}, //luma_contrast
		{0xb5, 0x08}, //luma_offset
		{0xb6, 0xe0},
		/* {0xd0, 0xcb}, */
		{0xd3, 0x85}, //ae_target
		{0xf2, 0x02},
		{0xf7, 0x12},
		{0xf8, 0x0a},
		{0x57, 0x84}, // 0x73 r_ratio 0x80
		{0x58, 0x80}, // g_ratio
		{0x59, 0x7b}, // b_ratio 0x80
		...
		{0xfe, 0x00},
		//{0x28,0x10},//0 001 0000
		{0x28, 0x00}, // 0 001 0000
		//{0x20,0xff},
		//{0x02,0x04},
