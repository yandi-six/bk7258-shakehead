...
SDK_CFG_MAP deviceInfoMap[] = {
    ...
    {"initString", &(runSystemCfg.deviceInfo.initString), SDK_CFG_DATA_TYPE_STRING, "PEU1iWtYJ5uy3NVaEt1EYs997rjvWgvX5lGZVGyCyIBX25+iXq1ihTsub1k6EI7NJku/mjFq8xcWAalAeViohvz32Mr4P+Y/qR8IlKUz9mlDAsC0PAfHZ3wb5NTENUkSnvDeV+lXjAfIgNrZZJL/YsRPJjQjGlW12kTzIFDgR8Q=", "ro", 1, MAX_STR_LEN_256, NULL},
    {"serverAddress", &(runSystemCfg.deviceInfo.serverAddress), SDK_CFG_DATA_TYPE_STRING, "webrtc.qq-kan.com", "ro", 1, MAX_STR_LEN_128, NULL},
    {"serialNumber", &(runSystemCfg.deviceInfo.serialNumber), SDK_CFG_DATA_TYPE_STRING, "RHZL-00-7R9T-N5LF-00002849", "ro", 1, MAX_STR_LEN_64, NULL},
    ...
    {"serverToken", &(runSystemCfg.deviceInfo.server_token), SDK_CFG_DATA_TYPE_STRING, "0", "rw", 1, MAX_STR_LEN_64, NULL},//+++
    {
        NULL,
    },
};
...
SDK_CFG_MAP timezoneCfgMap[] = {
    ...
    {"ntp", &(runSystemCfg.timezoneCfg.ntp), SDK_CFG_DATA_TYPE_STRING, "time.windows.com", "rw", 1, MAX_URL_STR_SIZE,  NULL},
    {"offset", &(runSystemCfg.timezoneCfg.offset), SDK_CFG_DATA_TYPE_S32, "8", "rw", -12, 12,  NULL},
    {"abbr", &(runSystemCfg.timezoneCfg.abbr), SDK_CFG_DATA_TYPE_STRING, "CST", "rw", 1, MAX_SYSTEM_STR_SIZE,  NULL},
    {"isdst", &(runSystemCfg.timezoneCfg.isdst), SDK_CFG_DATA_TYPE_S32, "0", "rw", 0, 1,  NULL},
    {"name", &(runSystemCfg.timezoneCfg.name), SDK_CFG_DATA_TYPE_STRING, "China Standard Time", "rw", 1, MAX_SYSTEM_STR_SIZE,  NULL},
    {"text", &(runSystemCfg.timezoneCfg.text), SDK_CFG_DATA_TYPE_STRING, "(UTC+08:00) Beijing, Chongqing, Hong Kong, Urumqi", "rw", 1, MAX_STR_LEN_64,  NULL},
