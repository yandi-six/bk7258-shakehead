...
#ifndef _SDK_CFG_EMAIL_H__
#define _SDK_CFG_EMAIL_H__
...
} SDK_NET_EMAIL_CFG, *LPSDK_NET_EMAIL_CFG;


extern int EmailCfgSave();
extern int EmailCfgLoad();
extern void EmailCfgPrint();
extern int EmailCfgLoadDefValue();
extern cJSON* EmailCfgLoadJson();
extern int EmailJsonSaveCfg(cJSON *json);
#define EMAIL_CFG_FILE "email_cfg.cjson"

extern SDK_NET_EMAIL_CFG runEmailCfg;
extern SDK_CFG_MAP emailMap[];
