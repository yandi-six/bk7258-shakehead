...
typedef struct {
	...
	audio_packet_t uac_mic_packet;
	audio_packet_t uac_spk_packet;
...
typedef struct {
	...
	aud_uac_mic_config_t *uac_mic_config;	//uac_config
...
typedef struct {
	...
	uint8_t *uac_spk_buff;			//uac speaker read data buffer
	uint32_t uac_spk_buff_size; 	//uac speaker read data buffer size (byte)
	aud_uac_spk_config_t *uac_spk_config;	//uac_config
...
#define DEFAULT_AUD_TRAS_DRV_INFO() {                                              \
        ...
        .mic_info = {                                                              \
                        ...
                        .uac_mic_packet = {                                        \
                                              .data_buffer = NULL,                 \
                                              .num_packets = 2,                    \
                                              .data_buffer_size = 640,             \
                                              .state = NULL,                       \
                                              .num_byte = NULL,                    \
                                              .actual_num_byte = NULL,             \
                                              .dev = USB_UAC_MIC_DEVICE,           \
                                          },                                       \
                    },                                                             \
        .spk_info = {                                                              \
                        .spk_en = false,                                           \
