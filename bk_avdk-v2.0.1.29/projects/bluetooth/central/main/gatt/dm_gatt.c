...
const uint8_t g_dm_gap_use_rpa = 1;
...
static uint8_t s_dm_gatt_privace_enable = 0;
...
int dm_gatt_main(void)
{
    ...
    //set privacy
    gatt_logi("set privacy %d", s_dm_gatt_privace_enable);

    ret = bk_ble_gap_config_local_privacy(s_dm_gatt_privace_enable);
