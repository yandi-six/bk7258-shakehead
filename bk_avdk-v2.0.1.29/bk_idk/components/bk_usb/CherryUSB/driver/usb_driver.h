...
#define USB_DRIVER_QITEM_COUNT 200
#define CONFIG_USB_DRIVER_TASK_SIZE 4096
...
typedef struct _bk_usb_device
{
	...
	struct usb_configuration_descriptor *current_configuration;
	struct usb_configuration_descriptor **apconfig_descriptors;
...
extern void usb_mailbox_slave_usb_driver_exit(void);
#endif
#endif
