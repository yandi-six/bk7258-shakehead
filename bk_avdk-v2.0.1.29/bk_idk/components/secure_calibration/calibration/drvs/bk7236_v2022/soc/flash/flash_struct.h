...
typedef volatile struct {
	...
	struct {
		union {
			struct {
				uint32_t flash_sec_start_addr0: 24; /**< bit[0:23] flash sec addr start */
				uint32_t flash_sec_addr0_en:     1; /**< bit[24] flash sec addr enable */
		...
		union {
			struct {
				uint32_t flash_sec_start_addr0: 24; /**< bit[0:23] flash sec addr end */
